...
import imgs from '../assets/uranus/assets-uranus';
import url3 from '../assets/uranus/uranus_rings_diff_01.jpg';
// import url4 from '../assets/uranus/uranus_rings_alpha_01.jpg';
// import bump from '../assets/uranus/assets-uranus-bump';
...
function ThreePlanetsUranus({ ...props }: ThreePlanetsProps) {
  ...
  return (
    <>
      ...
      <group {...props}>
        <mesh ref={ringRef} receiveShadow castShadow geometry={ringGeo}>
          <meshBasicMaterial
...
export default ThreePlanetsUranus;
