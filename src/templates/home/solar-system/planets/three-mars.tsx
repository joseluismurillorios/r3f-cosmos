...
import imgs from '../assets/mars/assets-mars';
// import bump from '../assets/mars/assets-mars-bump';
import ThreePlanet from '../three-planet';

type ThreePlanetsProps = ThreeElements['group'];

function ThreePlanetsMars({ ...props }: ThreePlanetsProps) {
...
export default ThreePlanetsMars;
